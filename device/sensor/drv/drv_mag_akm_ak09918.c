...
/*==============================================================================
  ...
  File Name         : drv_mag_akm_ak09918.c
  Version           : 1.0.0
  Date (MM/DD/YYYY) : 08/07/2018

when         who     what, where, why
----------   ---     -----------------------------------------------------------
08/03/18     AKM     Initial Edition, add AK09918 driver support
==============================================================================*/
...
#define CONVERT_TO_UGAUSS     1500                            /* 0.15uT = 1.5Gauss = 1500uGauss */
    ...
    size_t len)
{
    ...
    for (i = 0; i < 3; i++) {
        mag_data->data[i] = raw_lsb[i] * CONVERT_TO_UGAUSS;
    }
...
static int16_t drv_mag_akm_ak09918_set_default_config(const i2c_dev_t *dev)
{
    int16_t ret = 0;
...
int16_t drv_mag_akm_ak09918_ioctl(
    int           cmd,
    unsigned long arg)
{
    int16_t           ret = 0;
